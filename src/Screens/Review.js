...
const reviews = [
  {
    ...
    date: '10, May, 2023',
    review:
      'The product was great! I absolutely the vape! It was definitely a worth it buy! The product was great! I absolutely loved the vape! It was definitely a worth it buy!',
  },
  {
...
const total_avgStar =
  (5 * total_reviews.fiveStar +
    4 * total_reviews.fourStar +
    3 * total_reviews.threeStar +
    2 * total_reviews.twoStar +
    1 * total_reviews.oneStar) /
  total_reviews.total;
      ...
      <View style={styles.top_review}>
        <View style={styles.left}>
          <View style={styles.left_circle}>
            <Text style={styles.left_text}>{total_avgStar.toFixed(1)}</Text>
          </View>
        ...
        renderItem={({item}) => (
          <View style={styles.review_container}>
            ...
            <View style={{width: '80%', height: 'auto'}}>
              ...
              <View
                style={{alignItems: 'baseline', backgroundColor: '#F5F5F5'}}>
                <Rating
                  {...ratingProps}
